		...
		<view class="playsetting">
			...
			<view class="right_">
				<view class="radioView">
					<image v-show="musicInfo.musicPlayStatus" class=" imageadd imageadd2" src="../static/image/stop.png"
						style="" mode="" @click="settingPlay(0)"></image>
					<image v-show="!musicInfo.musicPlayStatus" class="imageadd imageadd2" src="../static/image/play.png"
	...
	<view v-show="props.meauStatus">
		<view class="radioMeau_left" :class="[showMeauStatus?'':'tranX2',showMeauStatus&&firstOpen?'tranX2-2':'']">
			<view class="titles" style="font-size: 16px;">
				<!-- {{musicInfo.musicName}} -->
				<uni-notice-bar :speed="300+'px'" scrollable single color="#000000" background-color="rgba(0,0, 0, 0)" :text="musicInfo.musicName" />
			</view>
			<image v-show="musicInfo.musicPlayStatus &&!showMeauStatus" class=" imageadd imageadd2"
